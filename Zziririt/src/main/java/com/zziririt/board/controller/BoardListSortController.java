...
/**
 * Servlet implementation class BoardListSortController
 */
@WebServlet("/sort.bo")
public class BoardListSortController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BoardListSortController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int exceptClosed = Integer.parseInt(request.getParameter("boxChecked"));
		...
		ArrayList<Board> list 
			= new BoardService().selectSort(pi, category);
		
		ArrayList<Board> list2 
			= new BoardService().selectSort(pi, exceptClosed);
