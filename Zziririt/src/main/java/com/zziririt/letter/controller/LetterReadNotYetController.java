...
/**
 * Servlet implementation class LetterReadNotYetController
 */
@WebServlet("/readNotYet.lo")
public class LetterReadNotYetController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public LetterReadNotYetController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Letter> list 
			= new LetterService().selectReadNotList(pi, userId);
		...
		request
			.getRequestDispatcher("views/letter/readNotListView.jsp")
