		...
		<form id="enroll-form" 
			...
			<table align="center">
				...
				<tr>
					<th>내용</th>
					<td>
						<pre><textarea name="letterContent" rows="10" id="letterContent" required style="resize : none;"><%=l.getLetterContent() %></textarea></pre>
					</td>
				</tr>
			</table>
