...
<div class="container" id="contentDiv" align="center">
	<div class="outer">
		...
		<table id="detail-area" align="center" 
			...
			<tr>
				<th width="70">읽은 시간</th>
				<td width="70"><%= l.getReceiveTime() %></td>
				<th width="70">작성일</th>
		...
		<div align="center">
			<a href="<%= contextPath %>/letterList.lo?currentPage=1&letterStatus=2" 
			   class="btn btn-secondary btn-sm">
				목록가기
			</a>

			
			<a href="<%= contextPath %>/lettersDelete.lo?deleteValues=<%= l.getLetterNo() %>&letterStatus=2" 
