...
<div class="container" id="contentDiv" align="center">
	<div class="outer">
		...
		<button class="allLetter" onclick="location.href = '<%= contextPath %>/letterList.lo?currentPage=1&letterStatus=1'">전체쪽지 (<%=listCountRe%>)</button>
		<button onclick="location.href = '<%= contextPath %>/readNotYet.lo?currentPage=1&letterStatus=1'">안읽은쪽지 (<%=listReadNot%>)</button>
