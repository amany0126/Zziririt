...
/**
 * Servlet implementation class GroupBulletinBoardReportList
 */
@WebServlet("/list.gbbrl")
public class GroupBulletinBoardReportList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GroupBulletinBoardReportList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount =  new AdminService().SelectGroupBoardReportListCount();
		...
		ArrayList<GroupBoard> list =  new AdminService().SelectGroupBoardReportList(pi);
