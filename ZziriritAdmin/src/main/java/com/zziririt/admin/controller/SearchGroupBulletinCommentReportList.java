...
/**
 * Servlet implementation class SearchGroupBulletinCommentReportList
 */
@WebServlet("/search.gbbcrl")
public class SearchGroupBulletinCommentReportList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchGroupBulletinCommentReportList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount =  new AdminService().searchSelectGruopCommentListCount(category, comment_Status);
		...
		ArrayList<GroupComment> list =  new AdminService().searchSelectGruopCommentList(pi, category, comment_Status);
		...
		if(category == " " && comment_Status == " ") {
			...
			request.getRequestDispatcher("views/admin/groupBulletinBoardCommentReportList.jsp").forward(request, response);	
