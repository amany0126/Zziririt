...
/**
 * Servlet implementation class SearchGroupMemberList
 */
@WebServlet("/search.gml")
public class SearchGroupMemberList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchGroupMemberList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount =  new AdminService().searchSelectGruopMemberListCount(category, search);
		...
		ArrayList<GroupMember> list =  new AdminService().searchSelectGruopMemberList(pi, category, search);
		...
		if(category == " " && search == " ") {
			...
			RequestDispatcher view = request.getRequestDispatcher("views/admin/groupMemberList.jsp");
