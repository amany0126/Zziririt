...
/**
 * Servlet implementation class MeetingMemberList
 */
@WebServlet("/list.mtm")
public class MeetingMemberList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MeetingMemberList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount =  new AdminService().selectMeetingMemberListCount();
		...
		ArrayList<MeetingMember> list =  new AdminService().selectMeetingMemberList(pi);
