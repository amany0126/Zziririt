...
/**
 * Servlet implementation class SearchMeetingList
 */
@WebServlet("/search.mt")
public class SearchMeetingList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchMeetingList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount =  new AdminService().searchSelectMeetingListCount(search);
		...
		ArrayList<Meeting> list =  new AdminService().searchSelectMeetingList(pi, search);
