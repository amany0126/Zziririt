...
/**
 * Servlet implementation class SearchGroupList
 */
@WebServlet("/search.gl")
public class SearchGroupList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount =  new AdminService().searchSelectGruopListCount(category, search);
		...
		ArrayList<Group> list =  new AdminService().searchSelectGruopList(pi, category, search);
		...
		if(category == " " && search == " ") {
			...
			RequestDispatcher view = request.getRequestDispatcher("views/admin/groupList.jsp");
