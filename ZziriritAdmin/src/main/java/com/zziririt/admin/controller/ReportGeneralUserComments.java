...
/**
 * Servlet implementation class ReportGeneralUserComments
 */
@WebServlet("/list.rguc")
public class ReportGeneralUserComments extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReportGeneralUserComments() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount =  new AdminService().selectCommonCommentReportListCount();
		...
		ArrayList<GeneralBulletinComment> list =  new AdminService().selectCommonCommentReportList(pi);
