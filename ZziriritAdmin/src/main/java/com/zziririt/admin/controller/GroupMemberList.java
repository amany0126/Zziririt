...
public class GroupMemberList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount =  new AdminService().SelectGroupUserCount();
		...
		ArrayList<GroupMember> list =  new AdminService().SelectGroupUserList(pi);
		...
		request.getRequestDispatcher("views/admin/groupMemberList.jsp").forward(request, response);
	}
