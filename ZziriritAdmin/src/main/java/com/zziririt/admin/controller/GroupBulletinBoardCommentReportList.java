...
/**
 * Servlet implementation class GroupBulletinBoardCommentReportList
 */
@WebServlet("/list.gbbcrl")
public class GroupBulletinBoardCommentReportList extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GroupBulletinBoardCommentReportList() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount =  new AdminService().selectGroupCommentReportListCount();
		...
		ArrayList<GroupComment> list =  new AdminService().selectGroupCommentReportList(pi);
