...
/**
 * Servlet implementation class SearchGeneralBulletinBoardReport
 */
@WebServlet("/search.gbbr")
public class SearchGeneralBulletinBoardReport extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchGeneralBulletinBoardReport() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount =  new AdminService().searchSelectGeneralBulletinBoardReportListCount(category, boardStatus);
		...
		ArrayList<GeneralBulletinBoard> list =  new AdminService().searchSelectGeneralBulletinBoardReportList(pi, category, boardStatus);
